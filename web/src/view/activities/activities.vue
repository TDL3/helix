  ...
  <div>
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        ...
        <el-form-item>
          <el-button @click="openDialog" type="primary">新增活动</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <el-table-column v-auth.not="888" label="申请人ID" prop="createdUserUuid" width="120"></el-table-column>
      ...
      <el-table-column label="按钮组">
        <template slot-scope="scope">
          <el-button class="table-button" @click="updateActivities(scope.row)" size="small" type="primary" icon="el-icon-edit">变更</el-button>
